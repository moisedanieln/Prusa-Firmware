...
#define DEFAULT_PWM_MOTOR_CURRENT  {270, 830, 850} // {XY,Z,E} HIGH CURRENT FOR E3D PANCAKE
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {540, 830, 900} // {XY,Z,E} HIGH CURRENT FOR E3D PANCAKE
#define Z_SILENT 0
